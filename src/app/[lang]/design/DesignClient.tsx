...
export default function DesignClient({ dict, lang }: { dict?: any, lang?: string }) {
  const d = dict || {};
  return (
    <div className="min-h-screen bg-[#030303] flex flex-col items-center justify-center p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-2xl mx-auto flex flex-col items-center">
        ...
        <p className="text-2xl text-white/80 font-light leading-relaxed mb-12 tracking-widest uppercase">
          {d.comingSoon}
        </p>
