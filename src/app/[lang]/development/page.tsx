...
export default function DevelopmentPage(props: { params: Promise<{ lang: string }> }) {
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        >
          ...
          <h1 className="text-6xl md:text-8xl lg:text-[110px] font-black tracking-tighter mb-10 leading-[1] text-white">
            {t("How we ", "Comment nous ")} <span className="text-[#DC143C] italic pr-2">{t("operate.", "opérons.")}</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-white/50 font-light max-w-3xl mx-auto leading-relaxed mb-20">
            {lang === "fr" ? (
              <>Nous ne faisons pas de modèles prédéfinis. Nous écrivons du <span className="text-white font-medium">code haute performance et évolutif</span> qui transforme des problèmes complexes en expériences numériques fluides.</>
            ) : (
        ...
        <div id="tech" className="mb-32 relative py-20 rounded-[3rem] border border-white/5 bg-[#030303] overflow-hidden scroll-mt-24">
          ...
          >
            <p className="text-[#DC143C] font-mono text-sm mb-6 uppercase tracking-widest">{t("Dependencies", "Dépendances")}</p>
            <h2 className="text-2xl md:text-4xl font-bold mb-10">{t("We operate with the latest technologies", "Nous opérons avec les dernières technologies")}</h2>
        ...
        <div className="relative z-10 w-full flex flex-col items-center mt-10 mb-32 py-32 px-6">
          ...
          <div className="w-full max-w-4xl mx-auto flex flex-col items-center relative z-10">
            <h2 className="text-4xl md:text-6xl font-black text-center mb-12 tracking-tighter uppercase">
              {t("Ready to see the ", "Prêt à voir les ")} <br className="md:hidden" />
