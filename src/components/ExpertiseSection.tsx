    ...
    >
      ...
      {!isMobile && (
        <motion.div 
          ...
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] md:w-[1200px] md:h-[1200px] pointer-events-none z-0 items-center justify-center transform-gpu flex"
        >
